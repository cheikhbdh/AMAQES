...
<main id="main" class="main">
    ...
    <button class="btn btn-primary" data-toggle="modal" data-target="#createInvitationModal">Create Campagne</button>
    ...
    <table class="table table-bordered mt-2">
        ...
        <tr>
            ...
            <td>
                <button class="btn btn-info" data-toggle="modal" data-target="#showInvitationModal{{ $invitation->id }}">Show</button>
                <button class="btn btn-warning" data-toggle="modal" data-target="#editInvitationModal{{ $invitation->id }}">Edit</button>
                <a href="{{ route('invitations.invite', $invitation->id) }}" class="btn btn-success {{ !$invitation->statue ? 'disabled' : '' }}">Inviter</a>
            </td>
        </tr>

        <!-- Show Modal -->
        <div class="modal fade" id="showInvitationModal{{ $invitation->id }}" tabindex="-1" aria-labelledby="showInvitationModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="showInvitationModalLabel">{{ $invitation->nom }}</h5>
        ...
        <!-- Edit Modal -->
        <div class="modal fade" id="editInvitationModal{{ $invitation->id }}" tabindex="-1" aria-labelledby="editInvitationModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="editInvitationModalLabel">Modifier {{ $invitation->nom }}</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
    ...
    <div class="modal fade" id="createInvitationModal" tabindex="-1" aria-labelledby="createInvitationModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="createInvitationModalLabel">Create Campagnes</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
...
@push('scripts')
<script>
    // Script to handle modal actions can be added here if needed
</script>
@endpush
@endsection
